          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                Para realizar login no Farma System o usuário deverá preencher
                um e-mail válido, sem se esquecer do '@' e da extensão '.com' ou
                '.com.br'. Além disso, no campo "Senha" é necessário informar
                uma senha com no mínimo 8 caracteres, que contenha pelo menos 1
                letra e 1 número.
              </div>
            </div>
          </div>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                ...
                no desenvolvimento do Farma System diferentes integrações com
                APIs de terceiros, desse modo existe a possibilidade de alguns
                desses serviços estarem fora do ar. Caso todos os dados tenham
                sido preenchidos corretamente no ato de cadastro de uma nova
                farmácia e ainda assim as informações não aparecerem
                ...
                ao desenvolvedor do Farma System.
              </div>
            </div>
          </div>
        </div>
